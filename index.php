...
<table width="998" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<div id='cssmenu'>
		<ul>
			<li><a href="?page_id=home"><span>HOME</span></a></li>
			<li><a href="?page_id=about-us"><span>ABOUT US</span></a></li>
			<li class='has-sub'><a href="?page_id=product&services"><span>PRODUCT & SERVICES</span></a>
				<ul>
					<li><a href="?page_id=#"><span>SolidWorks Standar</span></a></li>
					<li><a href="?page_id=#"><span>SolidWorks Profesional</span></a></li>
					<li><a href="?page_id=#"><span>SolidWorks Premium</span></a></li>
					<li><a href="?page_id=#"><span>SolidWorks Plastic</span></a></li>
					<li><a href="?page_id=#"><span>SolidWorks EPDM</span></a></li>
					<li><a href="?page_id=#"><span>SolidWorks Composer</span></a></li>
					<li class='last'><a href="?page_id=#"><span>SolidWorks Electrical</span></a></li>
				</ul>
			</li>
			<li><a href="?page_id=referral"><span>REFERRAL PROGRAM</span></a></li>
			<li class='has-sub'><a href="?page_id=#"><span>COMMUNITIES</span></a>
				<ul>
					<li><a href="https://www.facebook.com/SolidWorksADS"><img src="images/fb1.png" width="35" height="30"><span>Facebook</span></img></a></li>
					<li><a href="https://twitter.com/SolidWorksADS"><img src="images/twit1.png" width="35" height="30"><span>Twitter</span></img></a></li>
					<li class='last'><a href="http://solidworks.arismadata.com/blog/"><img src="images/blog1.png" width="30" height="30"><span>Blog</span></img></a></li>
				</ul>
			</li>
			
			<li><a href="?page_id=status"><span>STATUS</span></a></li>
			<li class='last'><a href="?page_id=contact-us"><span>CONTACT US</span></a></li>
		</ul>
	</div>
